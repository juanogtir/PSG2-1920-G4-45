...
public class PetController {
	...
	public String processCreationForm(final Owner owner, @Valid final Pet pet, final BindingResult result, final ModelMap model) {
		...
		if (pet.getBirthDate().isAfter(LocalDate.now())) {
			result.rejectValue("birthDate", "invalid", "La fecha de nacimiento debe de ser una fecha pasada");
		}
	...
	public String processDeleteForm(@PathVariable("petId") final int petId, @PathVariable final int ownerId, final ModelMap model) {
